...
export type { ProofOfTimeNFT } from "./contracts/VideoNFT.sol/ProofOfTimeNFT";
export { ProofOfTimeNFT__factory } from "./factories/contracts/VideoNFT.sol/ProofOfTimeNFT__factory";
